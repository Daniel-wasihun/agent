...
class AgroPestAgent:
        ...
        try:
            ...
            if self.model:
                prompt = dedent(f"""
                    ...
                    Provide a concise identification of the most likely pest and a brief explanation in plain text without any formatting.
                """)
                try:
                    response = self.model.generate_content(prompt)
    ...
    def generate_report(self, likely_pest: str, text_pests: List[str], 
        ...
        sections = [
            ...
            "\n",  # Adding blank line after AI response
            "**Pest Information**\n",
